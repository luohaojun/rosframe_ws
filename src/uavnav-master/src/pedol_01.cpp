...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        {
            Vec3 r1 = touch_point2 - touch_point1;
            double target_yaw1 = atan2(r1(1),r1(0));
        ...
        if(mission_state == GOTO_TOUCH_POINT2)
        {
            ...
            double target_yaw2 = atan2(r2(1), r2(0));
            static generalMove goto_touch_point2(ros::Time::now().toSec(),
                                                touch_point1_x, touch_point1_y, touch_point1_z, 0.0,
        ...
        if(mission_state == GOTO_TOUCH_POINT3)
        {
            ...
            double target_yaw3 = atan2(r3(1), r3(0));
            static generalMove goto_touch_point3(ros::Time::now().toSec(),
                                                touch_point2_x, touch_point2_y, touch_point2_z, 0.0,
